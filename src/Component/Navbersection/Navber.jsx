    ...
    return (
        ...
        <div className=''>
           ...
           <div className='md:flex-row flex-col flex justify-between items-center p-3'>
            ...
            <div className='md:flex-row flex-col flex items-center list-none gap-4 text-[#000000] '>
                <li><a href="#"></a>Home</li>
                <li><a href="#"></a>FAQ</li>
            ...
            {/* <div className='py-3'>
                <button className='text-[#FFFFFF] block sm:hidden rounded-md px-3 py-2 bg-gradient-to-r from-[#632EE3] to-[#9F62F2]'>+ NewTicket</button>
            </div> */}
           </div>
        </div>
        </div>
